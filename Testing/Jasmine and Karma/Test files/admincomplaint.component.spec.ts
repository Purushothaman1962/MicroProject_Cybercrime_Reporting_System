...
describe('Complaint Details Component Test', () => {
  beforeEach(async () => {
...
it('To test the component created', () => {
  const fixture = TestBed.createComponent(AdmincomplaintComponent);
...
it(`should have as title 'Complaint Component'`, () => {
  const fixture = TestBed.createComponent(AdmincomplaintComponent);
  const app = fixture.componentInstance;
  expect(app.title).toEqual('Complaint Details Component');
});
